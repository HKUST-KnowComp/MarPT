...
if __name__ == "__main__":
    for input_path in [
        "risk/result/meta-llama_Llama-3.1-8B-Instruct.json",
        "risk/result/mistralai_Mistral-7B-Instruct-v0.3.json",
        "risk/result/Qwen_Qwen2.5-7B-Instruct.json",
        "risk/result/Qwen_Qwen2.5-14B-Instruct.json",
        "risk/result/Qwen_Qwen2.5-32B-Instruct.json",
        "risk/result/Qwen_Qwen3-32B.json"
    ]:
        output_path = "risk/plot/"
